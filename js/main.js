document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('click', (event) => {
        // Check if the click is outside of the nav menu and the nav toggle button
    ...
    modalViews.forEach(modalView => {
        modalView.addEventListener('click', (event) => {
            if (event.target === modalView) { // Ensure click is on the background, not inside modal content
                closeAllModals();
            }
        });
    });
